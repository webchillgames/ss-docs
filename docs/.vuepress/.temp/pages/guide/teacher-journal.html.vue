...
<ol>
<li>
<p>Перейдите на <a href="https://new-school.geekbase.ru/teacher-journal/table" target="_blank" rel="noopener noreferrer">таблицу Журнала</a></p>
</li>
<li>
<p>Заполните поля <strong>ГОД</strong>, <strong>ПРЕДМЕТ</strong>, <strong>КЛАСС</strong></p>
</li>
</ol>
<blockquote>
<p>После заполнения этих полей в поле <strong>ПЕРИОД</strong> подтянутся доступные периоды!</p>
</blockquote>
<ol start="3">
<li>Выберите один из периодов в поле <strong>ПЕРИОД</strong></li>
</ol>
...
<img src="@source/guide/image.png" alt="alt text"></p>
</li>
</ol>
<blockquote>
<p>Появится кнопка <strong>СОЗДАТЬ ОЦЕНОЧНЫЙ</strong></p>
</blockquote>
<ol start="3">
<li>
<p>Нажмите на <strong>СОЗДАТЬ ОЦЕНОЧНЫЙ</strong></p>
</li>
<li>
<p>Заполните все поля и Сохраните</p>
</li>
</ol>
<blockquote>
<p><strong>ОЦЕНОЧНЫЙ ЛИСТ</strong> появится в списке</p>
</blockquote>
...
<blockquote>
<p>Появится кнопка <strong>СОЗДАТЬ ДИКТАНТ</strong></p>
</blockquote>
<ol start="3">
<li>
<p>Нажмите на <strong>СОЗДАТЬ ДИКТАНТ</strong></p>
</li>
<li>
<p>Заполните все поля и Сохраните</p>
</li>
...
<blockquote>
<p><strong>ДИКТАНТ</strong> появится в списке</p>
</blockquote>
